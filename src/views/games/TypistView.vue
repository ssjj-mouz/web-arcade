...
<header>
    ...
    <main id="game-area">
        ...
        <div class="overlay hidden" id="overlay">
            ...
            <button onclick="location.NaN" style="border-color:#64748b; color:#cbd5e1;">EXIT_TO_HUB()</button>
        </div>
    </main>
